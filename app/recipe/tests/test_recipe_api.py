...
class RecipeImageUploadTest(TestCase):
	...
	def test_upload_image_to_recipe(self):
		...
		with tempfile.NamedTemporaryFile(suffix='.jpg') as ntf:
			...
			ntf.seek(0)
			# Multipart of passing to post function so it isn't json becaus it is impage(multipart)
			# But by default it is json
	...
	def test_filter_recipe_by_tags(self):
		...
		tag1 = sample_tag(user=self.user, name='Vegan')
		tag2 = sample_tag(user=self.user, name='Vegrtarian')
	...
	def test_filter_recipe_by_ingredient(self):
		...
		ingredient1 = sample_ingredient(user=self.user, name='Feta cheee')
